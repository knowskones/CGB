...
If $ichkVersion = 1 Then
	...
	ElseIf $sBotVersion <> $lastversion Then
		SetLog("Congratulations you are running (" & $sBotVersion & ") " & @CRLF & "Please Run from .au3, Include Logs and ScreenCaptures with Bug Reports." & @CRLF & "Happy Botting!!!!", $COLOR_RED)
